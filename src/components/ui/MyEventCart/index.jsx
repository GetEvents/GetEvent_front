    ...
    <div className={styles.event_schow}>
      ...
      {loading ? (
              ...
              <div className={styles.events_schowdi} key={event.id}>
                ...
                <div className={styles.events_info}>
                  <div className={styles.eventsinfodetaille}>
                    ...
                    <div
                      className={styles.eventcreat}
                      key={event.organisateur.id}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                      ...
                      <p>Organisateur : {event.organisateur.nom}</p>
                    </div>
                  </div>
                  <div className={styles.eventactin}>
                    ...
                    {current_user.id == event.organisateur.id && (
                      <div className={styles.editdelect}>
                        <Link
                          className={styles.edit}
                          href={
                            eventExpired ? "#" : `/events/editEvent/${event.id}`
                          }
        ...
        <section id="page_404" className={styles.erreur}>
          <p>Vous n&apos;avez pas créé d&apos;événement pour l&apos;instant.</p>
        </section>
      )}
      <DelectModal
